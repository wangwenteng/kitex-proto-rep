...
import (
	...
	"kitex-demo/cmd/user/kitex_gen/user"
)
...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"AddFuncTest": kitex.NewMethodInfo(addFuncTestHandler, newAddFuncTestArgs, newAddFuncTestResult, false),
	}
...
func addFuncTestHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(user.FuncTestReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(user.UserSrv).AddFuncTest(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *AddFuncTestArgs:
		success, err := handler.(user.UserSrv).AddFuncTest(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*AddFuncTestResult)
		realResult.Success = success
	}
	return nil
}
func newAddFuncTestArgs() interface{} {
	return &AddFuncTestArgs{}
}

func newAddFuncTestResult() interface{} {
	return &AddFuncTestResult{}
}

type AddFuncTestArgs struct {
	Req *user.FuncTestReq
}

func (p *AddFuncTestArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in AddFuncTestArgs")
	}
	return proto.Marshal(p.Req)
}

func (p *AddFuncTestArgs) Unmarshal(in []byte) error {
	msg := new(user.FuncTestReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var AddFuncTestArgs_Req_DEFAULT *user.FuncTestReq

func (p *AddFuncTestArgs) GetReq() *user.FuncTestReq {
	if !p.IsSetReq() {
		return AddFuncTestArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *AddFuncTestArgs) IsSetReq() bool {
	return p.Req != nil
}

type AddFuncTestResult struct {
	Success *user.FuncTestRes
}

var AddFuncTestResult_Success_DEFAULT *user.FuncTestRes

func (p *AddFuncTestResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in AddFuncTestResult")
	}
	return proto.Marshal(p.Success)
}

func (p *AddFuncTestResult) Unmarshal(in []byte) error {
	msg := new(user.FuncTestRes)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *AddFuncTestResult) GetSuccess() *user.FuncTestRes {
	if !p.IsSetSuccess() {
		return AddFuncTestResult_Success_DEFAULT
	}
	return p.Success
}

func (p *AddFuncTestResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.FuncTestRes)
}

func (p *AddFuncTestResult) IsSetSuccess() bool {
	return p.Success != nil
}
...
func (p *kClient) AddFuncTest(ctx context.Context, Req *user.FuncTestReq) (r *user.FuncTestRes, err error) {
	var _args AddFuncTestArgs
	_args.Req = Req
	var _result AddFuncTestResult
	if err = p.c.Call(ctx, "AddFuncTest", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
