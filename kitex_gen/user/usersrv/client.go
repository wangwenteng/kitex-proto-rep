...
type Client interface {
	...
	AddFuncTest(ctx context.Context, Req *user.FuncTestReq, callOptions ...callopt.Option) (r *user.FuncTestRes, err error)
}
...
func (p *kUserSrvClient) AddFuncTest(ctx context.Context, Req *user.FuncTestReq, callOptions ...callopt.Option) (r *user.FuncTestRes, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AddFuncTest(ctx, Req)
}
